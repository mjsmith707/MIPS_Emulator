...
void MIPS_EXT() {
    ...
    memory->storeWordPhys(0xA0000000, 0x7d097c00);   // ext $t1, $t0, 16, 16
    cpu0->stepCPU(1);
...
void MIPS_INS() {
    ...
    memory->storeWordPhys(0xA0000000, 0x7d09fc04);   // ins $t1, $t0, 16, 16
    cpu0->stepCPU(1);
...
void MIPS_WSBH() {
    ...
    cpu0->setRegister(8, 0xdeadbeef);   // t0 = 0xdeadbeef
    cpu0->setRegister(9, 0x0);          // t1 = 0x0
    memory->storeWordPhys(0xA0000000, 0x7c0848a0);   // wsbh $t1, $t0
    cpu0->stepCPU(1);
