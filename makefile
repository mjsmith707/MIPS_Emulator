...
SOURCES=main.cpp CPU.cpp PMMU.cpp UART8250.cpp Coprocessor0.cpp COP0Register.cpp ConsoleUI.cpp MIPSException.cpp FileLoader.cpp
TESTSOURCES=STest/testmain.cpp STest/STest.cpp STest/MIPS_Tests_Common.cpp STest/ArithmeticTests.cpp STest/LogicalTests.cpp STest/BranchAndJumpTests.cpp STest/InstructionControlInstructionTests.cpp STest/LoadStoreMemoryControlTests.cpp STest/InsertExtractTests.cpp STest/MoveTests.cpp STest/ShiftTests.cpp STest/TrapTests.cpp STest/ObsoleteBranchTests.cpp STest/PrivilegedInstructionTests.cpp STest/ExceptionTests.cpp CPU.cpp PMMU.cpp UART8250.cpp Coprocessor0.cpp COP0Register.cpp ConsoleUI.cpp MIPSException.cpp
